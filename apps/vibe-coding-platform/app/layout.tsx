...
const description = `This is a demo of an end-to-end coding platform where the user can enter text prompts, and the agent will create a full stack application. It uses an E2B sandbox for secure code execution, Trigger.dev for background jobs, AI Gateway for GPT-5 and other models support, and it's built with Next.js and the AI SDK.`
